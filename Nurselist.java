...
public class Nurselist extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
        	layout.createParallelGroup(Alignment.TRAILING)
        		...
        		.addComponent(jScrollPane2, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 1281, GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
    	...
    	establishconnection ob=new establishconnection();
           String code="select * from employee15 where designation='Nurse';";
