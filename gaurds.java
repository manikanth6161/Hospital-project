 ...
 */
public class gaurds extends javax.swing.JFrame {

    /**
     * Creates new form gaurds
     */
    public gaurds() {
        initComponents();
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
    	...
    	establishconnection ob=new establishconnection();
           String code="select * from employee14 where designation='Gaurd';";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gaurds.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
