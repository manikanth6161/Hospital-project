 ...
 */
public class Activity_10 extends javax.swing.JFrame {
String path="";
    /**
...
public void clear(){
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
        ...
        checkcode= "select employeeID from employee13;";
        try{
       ...
       if(checksat.isSelected()==true)
           sat="P";
            code="insert into employee13 values('"+(txt_empID.getText())+"','"+txt_name.getText()+"','"+txt_specialization.getText()+"','"+txt_address.getText()+"','"+txt_dateofjoining.getText()+"','"+sun+"','"+mon+"','"+tue+"','"+wed+"','"+thu+"','"+fri+"','"+sat+"','"+txt_salary.getText()+"','"+txtcontacts.getText()+"','"+path+"','doctor');";
    ...
    private void btnsearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsearchActionPerformed
        ...
        if(!(txt_empID.getText().equals(""))){
            code="select * from employee13 where designation='doctor' && employeeID='"+txt_empID.getText()+"';";
            System.out.println(code);
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
       ...
       if(checksat.isSelected()==true)
           sat="P";
       code1="delete from employee13 where employeeID='"+txt_empID.getText()+"';";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Activity_10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
